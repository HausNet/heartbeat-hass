...
import heartbeat_client.client as hbc
from bravado.testing.response_mocks import BravadoResponseMock


class HeartbeatClientTests(test.TestCase):
    ...
    def test_get_device(self):
        ...
        self.assertEqual('device_C', device['name'])
    ...
    def test_heartbeat_spec_is_returned(self) -> None:
        ...
        self.assertIsNotNone(heartbeat_A)
        self.assertEqual(15, heartbeat_A['period_seconds'])
        self.assertIsNone(heartbeat_B)
